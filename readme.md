# 联合同盟宣言序言
[![](https://img.shields.io/badge/AI-unused-green)](#联合同盟宣言序言)
[![](https://img.shields.io/badge/translated-0%25-orange)](./readme_en.md)
...
2016年，我领悟出一个理论——联合同盟理论，当时受到不少同窗认可赞许  
如今十年已过，依然认为正确无比，遂着手详细描述成文并发布  
本文将阐述这一理论
...
本文分为三个部分，团结、维稳、优化  
**团结**是必要的，不然一定会毁于内战  
**维稳**同样是必要的，不然团结的成果一样会被破坏，不过优先级稍低  
**优化**是人类迈向美好生活的道路，属于锦上添花  
所以本文的**团结**部分为最核心观点；**维稳**部分是重要目标，方法仅供参考；**优化**部分更多只是建议
